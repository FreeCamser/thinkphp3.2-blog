...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="/thinkphp3/Public/style/style.css"/>
    <link rel="shortcut icon" href="http://yispace.net/wp-content/themes/weiweiqi/img/favicon.ico"/>
    <script src="/thinkphp3/Public/style/jquery.min.js"></script>
    <script src="/thinkphp3/Public/style/post.js"></script>
...
<div class="img">
    <img src="/thinkphp3/Public/images/head.png"  height="300"width="100%">
</div>
<div class="topbar">
    <div class="inner">

        <ul class="nav">
        <li ><a href="/thinkphp3/">首页</a></li>
            <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li ><a href="/thinkphp3/index.php/Home/Cate/index/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["catename"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            <li ><a href="/thinkphp3/index.php/Home/Message">留言板</a></li>
            <li ><a href="/thinkphp3/index.php/Home/Ping">Ping</a></li>
        </ul>
    </div>
</div>
<div class="wrapper">
    <div class="content">
        ...
        <div class="meta">
            ...
            <p class="meta-info">发表：<a href="/thinkphp3/index.php"><?php echo ($catename); ?></a> &nbsp;&nbsp; 发表日期：<?php echo (date("m-d",$arts["time"])); ?> &nbsp;&nbsp; </p>
        </div>
        ...
        <div class="entry">
            <p><img class="aligncenter size-full wp-image-42806"
                    src="/thinkphp3<?php echo ($arts["pic"]); ?>" width="630"
                    height="399"
                   /></p>
 ...
 <div class="sidebar">
        <img src="/thinkphp3/Public/images/touxiang.jpeg" height="150" >
        <div class="widget widget_categories"><h3 class="widget-tit">文章分类</h3>
            <ul>
                <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class=""><a href="/thinkphp3/index.php/Home/Cate/index/id/<?php echo ($vo["id"]); ?>" ><?php echo ($vo["catename"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="widget widget_recent_entries"><h3 class="widget-tit">最新发表</h3>
            <ul>
                <?php if(is_array($artres)): $i = 0; $__LIST__ = $artres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <a href="/thinkphp3/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a>
