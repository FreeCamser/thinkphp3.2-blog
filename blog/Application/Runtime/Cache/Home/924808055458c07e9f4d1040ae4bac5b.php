...
<div class="wrapper">
    <div class="content">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                <a href="/thinkphp3/index.php/Home/Article/index/<?php echo ($vo["id"]); ?>" class="pic"><img src="/thinkphp3<?php echo ($vo["pic"]); ?>" alt="<?php echo ($vo["title"]); ?>"/></a>
        ...
        <div class="paging"><?php echo ($page); ?>
        </div>
