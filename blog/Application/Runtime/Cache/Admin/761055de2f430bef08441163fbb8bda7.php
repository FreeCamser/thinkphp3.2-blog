...
<head>
    ...
    <script type="text/javascript" src="http://localhost/thinkphp3/Application/Admin/Public/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" src="http://localhost/thinkphp3/Application/Admin/Public/ueditor/ueditor.all.min.js"></script>
    <script type="text/javascript" src="http://localhost/thinkphp3/Application/Admin/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
</head>
<body>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea style="width:420px; height:100px;" name="desc"><?php echo ($articler["desc"]); ?></textarea>
                                </td>
                            </tr>                            
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($articler['pic'] != ''): ?><img src="/thinkphp3<?php echo ($articler["pic"]); ?>" height="100" >
                                        <?php else: ?>
                                        无缩略图<?php endif; ?>
                                </td>
                            </tr>
